            ...
            if self.count > self.indicator_warmup:
                if self.tech_data.empty:
                    ...
                    if self.count == self.model_warmup:
                        ...
                        #remove outliers at high value side
                        #self.Debug(self.tech_data.head())
                        ...
                        #self.Debug(self.scaled_data.describe())
                        #self.Debug(self.scaled_data.head())
                        ...
                        history_callback = self.model.fit(self.x_train,self.y_train,epochs=7,batch_size=32,verbose=2)
